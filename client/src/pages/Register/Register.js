        ...
        <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md">
          ...
          <Form layout="vertical" onFinish={onFinished}>
            <FormItem label="Name" name="name" rules={rules}>
              <Input placeholder="Enter your name" className="rounded-md py-2 px-4" />
            </FormItem>

            <FormItem label="Email" name="email" rules={rules}>
              <Input type="email" placeholder="Enter your email" className="rounded-md py-2 px-4" />
            </FormItem>

            <FormItem label="Password" name="password" rules={rules}>
              <Input.Password placeholder="Enter your password" className="rounded-md py-2 px-4" />
            </FormItem>
